...
const recordVitals = async (req, res) => {
  try {
    ...
    // Check that systolic pressure is greater than diastolic pressure
...
const getPatientVitals = async (req, res) => {
  try {
    ...
    console.error('Get Patient Vitals Error:', error.message);
...
const getLatestVitals = async (req, res) => {
  try {
    ...
    console.error('Get Latest Vitals Error:', error.message);
