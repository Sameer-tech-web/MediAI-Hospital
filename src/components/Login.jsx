...
/*
  Dynamic Environment Base URL with Fallback
*/
const API_URL =
  ...
  const handleStaffSubmit = async (e) => {
    ...
    try {
      ...
      if (contentType.includes('application/json')) {
        ...
        throw new Error(
          'Backend returned an invalid response format. Please check API routing.'
        );
      }
      ...
      */
      ...
      // Friendly fallback for network crashes/offline server
