    ...
    <div className="p-8 space-y-6 bg-medWhite min-h-full max-w-5xl mx-auto font-sans">
      ...
      <form onSubmit={handleUpdate} className="space-y-6">
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-sm rounded-xl shadow-md flex items-center gap-2 transition-colors cursor-pointer"
          >
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6">
        ...
        <form onSubmit={handleAddCustomIntervention} className="space-y-3 bg-purple-50/50 p-4 rounded-xl border border-purple-100">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold rounded-lg flex items-center gap-1.5 transition-colors cursor-pointer"
            >
