...
export default function PatientProfile({ patient, setActiveTab }) {
  // Safety fallback in case no patient has been selected.
  if (!patient) {
    return (
  ...
  const isCritical = patient.status === 'Critical Priority';
          ...
          <div className="flex items-start gap-4 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm text-slate-500 mt-2">
                {patient.age} Years • {patient.gender} • {patient.dept}
              </p>
            </div>
          </div>
